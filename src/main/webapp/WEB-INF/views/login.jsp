...
<div class="login-box">
    <div class="login-logo">
        <a href="<c:url value="/dashboard" />"><b>Cabin Operations</b> System</a>
    </div>
    <!-- /.login-logo -->
    <div class="login-box-body">
        <p class="login-box-msg">Sign in to start your cabin operations</p>
        ...
        <a href="<c:url value="cabincrew/cabincrew-register" />" class="text-center">Register a New Cabin Crew</a>
    </div>
    <!-- /.login-box-body -->
</div>
<!-- /.login-box -->
