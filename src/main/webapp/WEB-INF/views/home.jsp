...
<div class="content-wrapper">
	...
	<section class="content-header">
		<h1>
			Cabin Operation System <small>Version 1.0 (Beta)</small>
		</h1>
		<ol class="breadcrumb">
							...
							<div class="box-body">
								...
								<div class="direct-chat-messages">
									...
									<div class="direct-chat-msg">
										...
										<img class="direct-chat-img"
											src="<c:url value="/resources/dist/img/user1-128x128.jpg" />"
									...
									<div class="direct-chat-msg right">
										...
										<!-- /.direct-chat-info -->
										<img class="direct-chat-img"
											src="<c:url value="/resources/dist/img/user3-128x128.jpg" />"
											alt="message user image">
										<!-- /.direct-chat-img -->
								...
								<div class="direct-chat-contacts">
									<ul class="contacts-list">
										...
										<!-- End Contact Item -->
										<li><a href="#"> <img class="contacts-list-img"
												src="<c:url value="/resources/dist/img/user5-128x128.jpg" />"
												alt="User Image">
										...
										<!-- End Contact Item -->
										<li><a href="#"> <img class="contacts-list-img"
												src="<c:url value="/resources/dist/img/user6-128x128.jpg" />"
												alt="User Image">
										...
										<!-- End Contact Item -->
										<li><a href="#"> <img class="contacts-list-img"
												src="<c:url value="/resources/dist/img/user8-128x128.jpg" />"
												alt="User Image">
						...
						<div class="box box-danger">
							...
							<div class="box-body no-padding">
								<ul class="users-list clearfix">
									...
									<li><img
										src="<c:url value="/resources/dist/img/user4-128x128.jpg" />"
